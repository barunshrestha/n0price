					...
					<div class="row align-items-center">
						<div class="col-md-8 my-2 my-md-0">
							<div class="input-icon">
								<input type="text" class="form-control" placeholder="Search..." id="kt_datatable_search_query_roles" />
								<span>
		...
		<table class="datatable datatable-bordered" id="kt_datatable">
			...
			<tbody>
				...
				<tr>
					...
					<td>{{$role->alias}}</td>
					<td>
						<a href="{{route('roles.edit',$role->id)}}" class="btn btn-icon btn-success btn-xs mr-2 edit" data-toggle="tooltip" title="Edit"><i class="fa fa-pen"></i></a>
