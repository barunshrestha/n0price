...
<div class="card card-custom">
	<div class="card-header flex-wrap border-0 pt-6 pb-0">
		<div class="card-title">
			<h3 class="card-label">Guide Manuals
				<span class="d-block text-muted pt-2 font-size-sm">Guide Manuals</span>
			</h3>
		</div>
					...
					<div class="row align-items-center">
						<div class="col-md-8 my-2 my-md-0">
							<div class="input-icon">
								<input type="text" class="form-control" placeholder="Search..." id="kt_datatable_search_query_manuals" />
								<span>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						@if($post->post_category_id == $postcategory->id && $postcategory->id == 28)
...
<script type="text/javascript">
	var datatable = $('#kt_datatable').KTDatatable({
		...
		search: {
			input: $('#kt_datatable_search_query_manuals'),
			key: 'generalSearch'
		}
	});
