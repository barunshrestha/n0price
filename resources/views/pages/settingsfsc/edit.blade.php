...
<div class="card card-custom">
    ...
    ?>
	<form class="form" id="kt_form" action="{{route('servicecouponsettings.update',$data->id)}}" method="post" enctype="multipart/form-data">
		{{csrf_field()}}
		...
		<div class="card-body">
			<div class="form-group row">
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<input name="fsc_no" type="text" class="form-control form-control-solid name" 
					placeholder="Enter FSC No." required autocomplete="off" value="{{$data->fsc_no}}" />
				</div>
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<input name="effective_date" type="date" class="form-control form-control-solid" 
					placeholder="Enter Effective Date" required autocomplete="off" value="{{$data->effective_date}}"/>
				</div>
			</div>
            ...
            <div class="form-group row">
				...
				<div class="col-lg-2 col-md-2 col-sm-12">
					<input name="duration" type="text" class="form-control form-control-solid name" 
					placeholder="Enter Duration" required autocomplete="off" value="{{$data->duration}}"/>
				</div>
				<label class="col-form-label text-right col-lg-2 col-sm-12">Distance (Km Range)</label>
				<div class="col-lg-2 col-md-2 col-sm-12">
					<input name="distance" type="text" class="form-control form-control-solid name" 
					placeholder="Enter Distance" required autocomplete="off" value="{{$data->distance}}"/>
				</div>
				<label class="col-form-label text-right col-lg-2 col-sm-12">Discount</label>
				<div class="col-lg-2 col-md-2 col-sm-12">
					<input name="discount" type="text" class="form-control form-control-solid name" 
					placeholder="Enter Discount" required autocomplete="off"  value="{{$data->discount}}"/>
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    placeholder="Enter Instruction" required autocomplete="off" >{{$data->instruction}}</textarea>
				</div>
			</div>
