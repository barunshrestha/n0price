	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="login login-signin-on login-3 d-flex flex-row-fluid" id="kt_login">
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('{{ asset('media/bg/bg-11.jpg') }}');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						<!--begin::Login Header-->
						<div class="d-flex flex-center mb-6">
							<a href="#">
								<img src="{{asset('media/logos/hero-logo.png')}}" class="max-h-100px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
						...
						<div class="login-signin">
							<div class="mb-10">
								<h2 style="color: #ffffff;">HERO FSC</h2>
						  	...
						  	<form class="kt-form" action="{{route('login')}}" method="post" novalidate="novalidate">
								...
								<div class="form-group mb-5">
									<input class="form-control h-auto form-control-solid py-4 px-8 password" type="password" placeholder="Password" name="password" />
								</div>
