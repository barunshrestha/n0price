...
class UspGetCurrentTransaction extends Migration
{
    ...
    public function up()
    {
        ...
        // $procedure = "CREATE PROCEDURE usp_get_current_transaction(IN current_user_id varchar(50),IN current_portfolio_id varchar(50),IN secret_key varchar(50))
        //         BEGIN
        //         Select  tb.coin_name,
        //                 tb.coin_id,
        //                 tb.symbol,
        ...
        //                 tb.total_profit as total_profit,
